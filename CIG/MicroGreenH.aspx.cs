...
public partial class CIG_CIGMale : System.Web.UI.Page
{
    ...
    public static bool SaveFormDetail(MicroGreenHouse formDetail)
    {
        ...
        try
        {
            ...
            p[1] = new SqlParameter("@ActivityId", SqlDbType.Int) { Value =5 };
            ...
            p[4] = new SqlParameter("@NoOfSpecies", SqlDbType.Float) { Value = formDetail.NoOfBars };
            p[5] = new SqlParameter("@SpeciesUnit", SqlDbType.Int) { Value =3};
            ...
            bool flag = Convert.ToBoolean(dbT.ExecuteTransStoreProcedureReturn("spPageMicroGreenHouseSave", p, true, "@exist"));
            dbT.EndTransaction();
            return flag;
        }
        catch (Exception)
    ...
    public static List<Farmer> GetFarmerLists(string Id, string Year,string SeasonId)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageMicroGreenHouseFarmerList4GridView";
        com.CommandType = CommandType.StoredProcedure;
        ...
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 5;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static MicroGreenHouse EditFarmerDetail(string FormerId, string ExtWId, string Year, string SeasonId, string ActivityId, string FarmerActivityId)
    {
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageMicroGreenHouseGetFarmerDetailToUpdate";
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Year;
        ...
        MicroGreenHouse p = new MicroGreenHouse();
        while (dr.Read())
        {
            p.Area = dr["Area"].ToString();
            ...
            p.NoOfBars = dr["NoOfSpecies"].ToString();
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void UpdateDetail(MicroGreenHouse formDetail)
    {
        OCM_DbGeneral dbT = new OCM_DbGeneral();
        try
        {
            ...
            p[11] = new SqlParameter("@AreaUnit", SqlDbType.Int) { Value = 2 };
            p[12] = new SqlParameter("@FarmerActivityId", SqlDbType.VarChar) { Value = formDetail.FarmerActivityId };
            dbT.ExecuteTransStoreProcedure("spPageMicroGreenHouseUpdate", p, true);
            dbT.EndTransaction();
    ...
    public class MicroGreenHouse {
        ...
        public string FarmerId { get; set; }
        public string NoOfBars { get; set; }
        public string Area { get; set; }
