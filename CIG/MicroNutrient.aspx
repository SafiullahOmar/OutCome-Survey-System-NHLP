        ...
        $(function () {
            ...
            $("#<%=ddlProvince.ClientID%>").change(function () {
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "MicroNutrient.aspx/GetDistrict",
            ...
            $("#ddlDistrict").change(function () {
                ...
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "MicroNutrient.aspx/GetExtensionW",
            ...
            $("#ddlExtensionW").change(function () {
                ...
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "MicroNutrient.aspx/GetFarmers",
                        data: ExtObj,
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
            ...
            $('#txtArea').keyup(function () {
                if ($(this).val() != "") {
                    Ftotal = parseFloat($(this).val()) * 1;
                    $('#txtNutrient').val(Ftotal.toString());
                } else {
                    $('#txtNutrient').val('');
                }
            });
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txtGarden">
                                    Micro Nutrient Per KG</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtNutrient" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
