...
public partial class CIG_PlasticTunnel : System.Web.UI.Page
{
    ...
    public static bool SaveFormDetail(PlasticTunnel formDetail)
    {
        ...
        try
        {
            ...
            if (formDetail.CropList.Count > 0)
            {
                foreach (Crop G in formDetail.CropList)
                {
                    ...
                    p[3] = new SqlParameter("@ActivityId", SqlDbType.Float) { Value = 12 };
                    ...
                    flag = Convert.ToBoolean(dbT.ExecuteTransStoreProcedureReturn("spPagePlasticTunnelSave", p, true, "@exist"));
                    if (flag == true)
                    {
    ...
    public static List<Farmer> GetFarmerLists(string Id, string Year, string SeasonId)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPagePlasticTunnelFarmerList4GridView";
        com.CommandType = CommandType.StoredProcedure;
        ...
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 12;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static PlasticTunnel EditFarmerDetail(string FormerId, string ExtWId, string Year, string SeasonId, string FarmerActivityId)
    {
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPagePlasticTunnelGetFarmerDetailToUpdate";
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Year;
        ...
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        PlasticTunnel K = new PlasticTunnel();
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void UpdateDetail(PlasticTunnel formDetail)
    {
        OCM_DbGeneral dbT = new OCM_DbGeneral();
        try
        {
            ...
            c[3] = new SqlParameter("@ActivityId", SqlDbType.Float) { Value = 12 };
            ...
            if (formDetail.CropList.Count > 0)
            {
                foreach (Crop G in formDetail.CropList)
                {
                    ...
                    dbT.ExecuteTransStoreProcedure("spPagePlasticTunnelUpdate", p, true);
