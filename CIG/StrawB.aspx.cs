...
public partial class CIG_CIGMale : System.Web.UI.Page
{
    ...
    public static bool SaveFormDetail(SFProduction formDetail)
    {
        ...
        try
        {
            ...
            p[1] = new SqlParameter("@ActivityId", SqlDbType.Int) { Value =6 };
            ...
            p[4] = new SqlParameter("@NoOfSpecies", SqlDbType.Float) { Value = formDetail.NoOfSapples };
            p[5] = new SqlParameter("@SpeciesUnit", SqlDbType.Int) { Value =4};
            ...
            bool flag = Convert.ToBoolean(dbT.ExecuteTransStoreProcedureReturn("spPageSFProductionSave", p, true, "@exist"));
            dbT.EndTransaction();
            return flag;
        }
        catch (Exception)
    ...
    public static List<Farmer> GetFarmerLists(string Id, string Year,string SeasonId)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageSFProductionFarmerList4GridView";
        com.CommandType = CommandType.StoredProcedure;
        ...
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 6;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static SFProduction EditFarmerDetail(string FormerId, string ExtWId, string Year, string SeasonId, string ActivityId, string FarmerActivityId)
    {
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageSFProductionGetFarmerDetailToUpdate";
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Year;
        ...
        SFProduction p = new SFProduction();
        while (dr.Read())
        {
            p.Area = dr["Area"].ToString();
            ...
            p.NoOfSapples = dr["NoOfSpecies"].ToString();
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void UpdateDetail(SFProduction formDetail)
    {
        OCM_DbGeneral dbT = new OCM_DbGeneral();
        try
        {
            ...
            dbT.ExecuteTransStoreProcedure("spPageSFProductionUpdate", p, true);
            dbT.EndTransaction();
    ...
    public class SFProduction {
        ...
        public string FarmerId { get; set; }
        public string NoOfSapples { get; set; }
        public string Area { get; set; }
