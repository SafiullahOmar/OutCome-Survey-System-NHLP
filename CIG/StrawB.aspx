<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="StrawB.aspx.cs" Inherits="CIG_CIGMale" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#txtArea').keyup(function () {
                if ($(this).val() != "") {
                    Ftotal = parseFloat($(this).val()) * 7000;
                    $('#txtSapples').val(Ftotal.toString());
                } else {
                    $('#txtSapples').val('');
                }
            });
