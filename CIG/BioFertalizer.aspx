<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="BioFertalizer.aspx.cs" Inherits="CIG_CIGMale" %>
        ...
        $(function () {
            ...
            $("#<%=ddlProvince.ClientID%>").change(function () {
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "BioFertalizer.aspx/GetDistrict",
            ...
            $("#ddlDistrict").change(function () {
                ...
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "BioFertalizer.aspx/GetExtensionW",
            ...
            $("#ddlExtensionW").change(function () {
                ...
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "BioFertalizer.aspx/GetFarmers",
                        data: ExtObj,
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
            ...
            $("#ddlFruitType").change(function () {
                if ($(this).val() == "-1") {
                    $("#txtLatitude").val('').attr("disabled", "disabled");
                    $("#txtLongtitude").val('').attr("disabled", "disabled");
                    $("#txtBioNutrient").val('').attr("disabled", "disabled");
                    $("#txtArea").val('').attr("disabled", "disabled");

                }
                else {

                    $("#txtLatitude").val('').attr("disabled",false);
                    $("#txtLongtitude").val('').attr("disabled",false);
                    $("#txtBioNutrient").val('').attr("disabled",false);
                    $("#txtArea").val('').attr("disabled",false);
            ...
            $('#txtArea').keyup(function () {
                if ($(this).val() != "") {
                    Ftotal = parseFloat($(this).val()) * 0.5;
                    $('#txtBioNutrient').val(Ftotal.toString());
                } else {
                    $('#txtBioNutrient').val('');
                }
            });
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="txtGarden">
                                    Bio Nutrient Per KG</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtBioNutrient" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
