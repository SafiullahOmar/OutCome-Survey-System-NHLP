<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Pistachio.aspx.cs" Inherits="CIG_CIGMale" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPgContent" runat="Server">
        ...
        $(function () {
            ...
            $("#<%=ddlProvince.ClientID%>").change(function () {
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Pistachio.aspx/GetDistrict",
            ...
            $("#ddlDistrict").change(function () {
                ...
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Pistachio.aspx/GetExtensionW",
            ...
            var Stotal = 0;
            $('#txtSeedsArea').keyup(function () {
                if ($(this).val() != "") {
                    Stotal = parseFloat($(this).val()) * 0.5;
                    $('#txtSeeds').val(Stotal.toString());
                } else {
                    $('#txtSeeds').val('');
                }
            });
            var Trtotal = 0;
            $('#txtSapplesArea').keyup(function () {
                if ($(this).val() != "") {
                    Trtotal = parseFloat($(this).val()) *222;
                    $('#txtSapples').val(Trtotal.toString());
                } else {
                    $('#txtSapples').val('');
                }
            });
            var Hingtotal = 0;
            $('#txtHingArea').keyup(function () {
                if ($(this).val() != "") {
                    Hingtotal = parseFloat($(this).val()) * 0.5;
                    $('#txtHing').val(Hingtotal.toString());
                } else {
                    $('#txtHing').val('');
                }
            });
    ...
    <div class="container-fluid container-fullw bg-white">
        ...
        <div class="row bg-light-grey">
            <div class="col-md-12">
                <fieldset>
                    <legend>Details for Seeds Area</legend>
                    <div class="row">
                        <div class="col-md-6">

                            <div class="form-group">
                                <label for="txtSeedsArea">
                                    <input type="checkbox" id="chkSeeds" />
                                    Area (Gerib)</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtSeedsArea" />
                            </div>
        ...
        <div class="row bg-light-grey">
            <div class="col-md-12">
                <fieldset>
                    <legend>Details for Sapples Area</legend>
                    <div class="row">
                        <div class="col-md-6">

                            <div class="form-group">
                                <label for="txtSapplesArea">
                                    <input type="checkbox" id="chkSapples" />
                                    Area (Gerib)</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtSapplesArea" />
                            </div>

                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="txtSapples">
                                    No of trees/cuttings</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtSapples" />
                            </div>
                        </div>
                    </div>
           ...
           <div class="row bg-light-grey">
            <div class="col-md-12">
                <fieldset>
                    <legend>Details for Hing</legend>
                    <div class="row">
                        <div class="col-md-6">

                            <div class="form-group">
                                <label for="txtHingArea">
                                    <input type="checkbox" id="chkHing" />
                                    Area (Gerib)</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtHingArea" />
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="txtHing">
                                    Hing/kg</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtHing" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="row">                    
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txtTanker">
                                    <input type="checkbox" id="chkTanker" />
                                    No OF Water Tank</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtTanker" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="checkbox" id="chkFence" />
                                <label for="txtFence">
                                    Fence (M )</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtFence" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
