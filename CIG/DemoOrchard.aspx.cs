...
public partial class CIG_CIGMale : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static List<FruitVariety> GetVaiety(string FruitId)
    {
        List<FruitVariety> lst = new List<FruitVariety>();
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandType = CommandType.StoredProcedure;
        com.CommandText = "SharedGetFruitVariety";
        com.Parameters.AddWithValue("@FruitId", SqlDbType.Int).Value =FruitId;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
    ...
    public static bool SaveFormDetail(DemoOrchard formDetail)
    {
        ...
        try
        {
            ...
            p[1] = new SqlParameter("@ActivityId", SqlDbType.Int) { Value =4 };
            ...
            p[4] = new SqlParameter("@FruitCropId", SqlDbType.Int) { Value = formDetail.FruitId };
            p[5] = new SqlParameter("@NoOfSpecies", SqlDbType.Float) { Value = formDetail.NoOfTree };
            p[6] = new SqlParameter("@SpeciesUnit", SqlDbType.Int) { Value =1};
            p[7]=new SqlParameter("@Area",SqlDbType.Decimal){Value=formDetail.Area};
            p[8] = new SqlParameter("@VarietyId", SqlDbType.Int) { Value = formDetail.VarietyId };
            p[9] = new SqlParameter("@DensityType", SqlDbType.Int) { Value = formDetail.Density };
            ...
            p[16] = new SqlParameter("@exist", SqlDbType.Bit);
            p[16].Direction = ParameterDirection.Output;
            bool flag = Convert.ToBoolean(dbT.ExecuteTransStoreProcedureReturn("spPageDemoOrchardSave", p, true, "@exist"));
            dbT.EndTransaction();
            return flag;
        }
        catch (Exception)
    ...
    public static List<Farmer> GetFarmerLists(string Id, string Year,string SeasonId)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageDemoOrchardFarmerList4GridView";
        com.CommandType = CommandType.StoredProcedure;
        ...
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 4;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
            ...
            p.FruitCropId = dr["FruitCropId"].ToString();
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static DemoOrchard EditFarmerDetail(string FormerId, string ExtWId, string Year, string SeasonId, string ActivityId, string FruitCropId, string FActivityId)
    {
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageDemoOrchardGetFarmerDetailToUpdate";
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Year;
        ...
        com.Parameters.AddWithValue("@SeasonId", SqlDbType.Int).Value = SeasonId;
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 4;
        com.Parameters.AddWithValue("@FruitCropId", SqlDbType.Int).Value = FruitCropId;
        com.Parameters.AddWithValue("@FarmerActivityId", SqlDbType.VarChar).Value = FActivityId;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();

        DemoOrchard p = new DemoOrchard();
        while (dr.Read())
        {
            p.Area = dr["Area"].ToString();
            p.DistrictId = dr["DistrictID"].ToString();
            p.Density = dr["DensityType"].ToString();
            p.VarietyId = dr["VarietyId"].ToString();
            ...
            p.NoOfTree = dr["NoOfSpecies"].ToString();
            p.ProvinceId = dr["ProvinceID"].ToString();
            p.SeasonId = dr["SeasonId"].ToString();
            p.Year = dr["Year"].ToString();
            p.DetailId = dr["Id"].ToString();
        }
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void UpdateDetail(DemoOrchard formDetail)
    {
        OCM_DbGeneral dbT = new OCM_DbGeneral();
        try
        {
            ...
            p[11] = new SqlParameter("@Latitude", SqlDbType.NVarChar) { Value = formDetail.Latitude };
            p[12] = new SqlParameter("@UserId", SqlDbType.UniqueIdentifier) { Value = new System.Data.SqlTypes.SqlGuid(usr.ProviderUserKey.ToString()) };
            p[13] = new SqlParameter("@UpdationDate", SqlDbType.NVarChar) { Value = DateTime.Now.ToString() };
            p[14] = new SqlParameter("@AreaUnit", SqlDbType.Int) { Value = 1 };
            p[15] = new SqlParameter("@FarmerActivityId", SqlDbType.VarChar) { Value = formDetail.FarmerActivityId };
            p[16] = new SqlParameter("@DetailId", SqlDbType.VarChar) { Value = formDetail.DetailId };
            dbT.ExecuteTransStoreProcedure("spPageDemoOrchardUpdate", p, true);
            dbT.EndTransaction();
    ...
    public class Farmer
    {
        ...
        public string FruitCropId { get; set; }
