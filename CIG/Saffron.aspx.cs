...
public partial class CIG_CIGMale : System.Web.UI.Page
{
    ...
    public static bool SaveFormDetail(SaffronProduction formDetail)
    {
        ...
        try
        {
            ...
            p[1] = new SqlParameter("@ActivityId", SqlDbType.Int) { Value =7 };
            ...
            p[4] = new SqlParameter("@NoOfSpecies", SqlDbType.Float) { Value = formDetail.Saffron };
            ...
            bool flag = Convert.ToBoolean(dbT.ExecuteTransStoreProcedureReturn("spPageSaffronSave", p, true, "@exist"));
            dbT.EndTransaction();
            return flag;
        }
        catch (Exception)
    ...
    public static List<Farmer> GetFarmerLists(string Id, string Year,string SeasonId)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageSaffronFarmerList4GridView";
        com.CommandType = CommandType.StoredProcedure;
        ...
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 7;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static SaffronProduction EditFarmerDetail(string FormerId, string ExtWId, string Year, string SeasonId, string ActivityId, string FarmerActivityId)
    {
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageSaffronGetFarmerDetailToUpdate";
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Year;
        ...
        SaffronProduction p = new SaffronProduction();
        while (dr.Read())
        {
            p.Area = dr["Area"].ToString();
            ...
            p.Saffron = dr["NoOfSpecies"].ToString();
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void UpdateDetail(SaffronProduction formDetail)
    {
        OCM_DbGeneral dbT = new OCM_DbGeneral();
        try
        {
            ...
            dbT.ExecuteTransStoreProcedure("spPageSaffronUpdate", p, true);
            dbT.EndTransaction();
    ...
    public class SaffronProduction {
