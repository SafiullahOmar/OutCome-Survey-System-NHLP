<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="CDCProjects.aspx.cs" Inherits="CIG_PlasticTunnel" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPgContent" runat="Server">
    <script src="../Script/CDCProjects.js"></script>
        ...
        $(function () {
            ...
            $("#<%=ddlProvince.ClientID%>").change(function () {
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CDCProjects.aspx/GetDistrict",
            ...
            $("#ddlDistrict").change(function () {
                ...
                if ($(this).val() == "-1") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CDCProjects.aspx/GetExtensionW",
            ...
            <div class="col-md-10   ">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="ddlProject">Project Type</label>
                                <select class="form-control " id="ddlProject">
                                    <option value="-1">--Select--</option>
                                    <option value="1">Water HS</option>
                                    <option value="2">Raison MH</option>
                                    <option value="3">Bore Well</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txtContractCost">
                                    Total Price of Contract</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtContractCost" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txtNhlpCost">
                                    Total Payable AFS by NHLP
                                </label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtNhlpCost" />
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="txtOwnerName">
                                    Project Owner Name</label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtOwnerName" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="txtOwnerContactNo">
                                    Owner Contact No
                                </label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtOwnerContactNo" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="txtNoOfMembers">
                                    No Of Other Members in project
                                </label>
                                <input type="text" class="form-control" placeholder="0.00" id="txtNoOfMembers" />
                            </div>
                        </div>
    ...
    <input type="hidden" id="hdnCommunityId" /><input type="hidden" id="hdnExtWIdFarmerId" /><input type="hidden" id="hdnProjectId" />
