...
public partial class CIG_CIGMale : System.Web.UI.Page
{
    ...
    public static List<Fruit> GetFruit()
    {
        ...
        com.Parameters.AddWithValue("@ActivityId", SqlDbType.Int).Value = 8;
        con.Open();
        SqlDataReader dr = com.ExecuteReader();
        while (dr.Read())
        {
    ...
    public static bool SaveFormDetail(BioNutrientFertalizer formDetail)
    {
        ...
        try
        {
            ...
            p[1] = new SqlParameter("@ActivityId", SqlDbType.Int) { Value =8 };
            p[2] = new SqlParameter("@FruitCropId", SqlDbType.Int) { Value =formDetail.FruitCropId  };
            p[3]=new SqlParameter("@Year",SqlDbType.Int){Value=formDetail.Year};
            p[4]=new SqlParameter("@SeasonId",SqlDbType.Int){Value=formDetail.SeasonId};
            p[5] = new SqlParameter("@NoOfSpecies", SqlDbType.Float) { Value = formDetail.BioNutrient };
            p[6] = new SqlParameter("@SpeciesUnit", SqlDbType.Int) { Value =5};
            p[7]=new SqlParameter("@Area",SqlDbType.Decimal){Value=formDetail.Area};
            p[8]=new SqlParameter("@Longtitude",SqlDbType.NVarChar){Value=formDetail.Longtitude};
            ...
            p[11] = new SqlParameter("@InsertionDate", SqlDbType.NVarChar) { Value = DateTime.Now.ToString() };
            p[12] = new SqlParameter("@IsDeleted", SqlDbType.Bit) { Value =0 };
            ...
            bool flag = Convert.ToBoolean(dbT.ExecuteTransStoreProcedureReturn("spPageBioNutrientSave", p, true, "@exist"));
            dbT.EndTransaction();
            return flag;
        }
        catch (Exception)
    ...
    public static List<Farmer> GetFarmerLists(string Id, string Year,string SeasonId)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageBioNutrientFarmerList4GridView";
        com.CommandType = CommandType.StoredProcedure;
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static BioNutrientFertalizer EditFarmerDetail(string FormerId, string ExtWId, string Year, string SeasonId, string ActivityId, string FarmerActivityId)
    {
        string constr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["OCMCon"].ConnectionString;
        SqlConnection con = new SqlConnection(constr);
        SqlCommand com = con.CreateCommand();
        com.CommandText = "spPageBioNutrientGetFarmerDetailToUpdate";
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Year;
        ...
        BioNutrientFertalizer p = new BioNutrientFertalizer();
        while (dr.Read())
        {
            p.Area = dr["Area"].ToString();
            ...
            p.BioNutrient = dr["NoOfSpecies"].ToString();
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void UpdateDetail(BioNutrientFertalizer formDetail)
    {
        OCM_DbGeneral dbT = new OCM_DbGeneral();
        try
        {
            ...
            p[9] = new SqlParameter("@Latitude", SqlDbType.NVarChar) { Value = formDetail.Latitude };
            p[10] = new SqlParameter("@UserId", SqlDbType.UniqueIdentifier) { Value = new System.Data.SqlTypes.SqlGuid(usr.ProviderUserKey.ToString()) };
            p[11] = new SqlParameter("@UpdationDate", SqlDbType.NVarChar) { Value = DateTime.Now.ToString() };
            ...
            p[14] = new SqlParameter("@DetailId", SqlDbType.VarChar) { Value = formDetail.DetailId };
            dbT.ExecuteTransStoreProcedure("spPageBioNutrientUpdate", p, true);
            dbT.EndTransaction();
    ...
    public class BioNutrientFertalizer {
        ...
        public string FarmerId { get; set; }
        public string BioNutrient { get; set; }
        public string Area { get; set; }
