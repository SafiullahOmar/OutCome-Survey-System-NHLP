...
function formValidation(e) {
    ...
    if ($('#txtSapples').val() == '') {
        $('#txtSapples').css('background-color', '#FFAAAA');
        flag = false;
    }
    else { $('#txtSapples').css('background-color', '#ffff'); }
...
function SaveFormerInfo() {
    ...
    formDetail.NoOfSapples = $('#txtSapples').val();
    ...
    $.ajax({
        type: "POST",
        url: "StrawB.aspx/SaveFormDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
...
function ShowFarmers(obj) {
    $.ajax({
        type: "POST",
        url: "StrawB.aspx/GetFarmerLists",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function EditFarmerDetail(obj) {
    ...
    var obj = JSON.stringify({ FormerId: FormerId, ExtWId: ExtWId, Year: Year,SeasonId:SeasonId ,ActivityId:"6",FarmerActivityId:FarmerActivityId});
    $.ajax({
        type: "POST",
        url: "StrawB.aspx/EditFarmerDetail",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (r) {
            ...
            $('#txtSapples').val(r.d.NoOfSapples);
