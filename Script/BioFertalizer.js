function LoadFruit() {
    $.ajax({
        type: "POST",
        url: "BioFertalizer.aspx/GetFruit",
        data: '',
        dataType: "json",
...
function formValidation(e) {
    ...
    if ($('#txtBioNutrient').val() == '') {
        $('#txtBioNutrient').css('background-color', '#FFAAAA');
        flag = false;
    }
    else { $('#txtBioNutrient').css('background-color', '#ffff'); }
...
function SaveFormerInfo() {
    ...
    formDetail.BioNutrient = $('#txtBioNutrient').val();
    formDetail.FruitCropId = $('#ddlFruitType').val();
    ...
    $.ajax({
        type: "POST",
        url: "BioFertalizer.aspx/SaveFormDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
...
function ShowFarmers(obj) {
    $.ajax({
        type: "POST",
        url: "BioFertalizer.aspx/GetFarmerLists",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
            var $table = "<table id='tblFarmersDetail'  width='100%' class='table table-striped table-bordered  table-hover'>";
            var header = "<thead><tr ><th>SN</th><th style='text-align:center;'>Name</th><th style='text-align:center;'>Father Name</th><th style='text-align:center;'>Area</th><th style='text-align:center;'>Type</th><th style='text-align:center;'>Year</th><th style='text-align:center;'></th></thead>";
            $table += header;
            var count = 1;
...
function EditFarmerDetail(obj) {
    ...
    $.ajax({
        type: "POST",
        url: "BioFertalizer.aspx/EditFarmerDetail",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (r) {
            ...
            $("#ddlFruitType").val(r.d.FruitCropId);
            $('#ddlExtensionW').val(r.d.ExtId);
            $('#txtBioNutrient').val(r.d.BioNutrient);
...
function Update() {
    ...
    $.ajax({
        type: "POST",
        url: "BioFertalizer.aspx/UpdateDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
