...
function SaveFormerInfo() {
    ...
    formDetail.Nutrient = $('#txtNutrient').val();
    ...
    $.ajax({
        type: "POST",
        url: "MicroNutrient.aspx/SaveFormDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
...
function ShowFarmers(obj) {
    $.ajax({
        type: "POST",
        url: "MicroNutrient.aspx/GetFarmerLists",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function EditFarmerDetail(obj) {
    ...
    $.ajax({
        type: "POST",
        url: "MicroNutrient.aspx/EditFarmerDetail",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (r) {
...
function Update() {
    ...
    $.ajax({
        type: "POST",
        url: "MicroNutrient.aspx/UpdateDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
        contentType: "application/json; charset=utf-8",
