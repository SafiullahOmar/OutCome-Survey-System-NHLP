...
function formValidation(e) {
    ...
    if ($('#txtSaffron').val() == '') {
        $('#txtSaffron').css('background-color', '#FFAAAA');
        flag = false;
    }
    else { $('#txtSaffron').css('background-color', '#ffff'); }
...
function SaveFormerInfo() {
    ...
    formDetail.Saffron = $('#txtSaffron').val();
    ...
    $.ajax({
        type: "POST",
        url: "Saffron.aspx/SaveFormDetail",
        data: jsonObject,
        dataType: "json",
        async: false,
...
function ShowFarmers(obj) {
    $.ajax({
        type: "POST",
        url: "Saffron.aspx/GetFarmerLists",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function EditFarmerDetail(obj) {
    ...
    $.ajax({
        type: "POST",
        url: "Saffron.aspx/EditFarmerDetail",
        data: obj,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (r) {
